...
The objective of the protocol is the key authentication:
...
If $A \believes B \oncesaid payload_{M2}$, $A \believes B \oncesaid A \sharekey{k_s, k_a} B$ too beacuse the payload contains the keys.

\begin{align}
\frac{A \believes \fresh{A \sharekey{k_s, k_a} B}, A \believes B \oncesaid A \sharekey{k_s, k_a} B}{A \believes B \believes A \sharekey{k_s, k_a} B} \tag*{postulate 2}
\end{align}
